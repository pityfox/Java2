...
//	private List<Client> clients = new ArrayList<Client>();
	...
	public Compte2(String numCompte, boolean joint, long solde) {
		this.numCompte = numCompte;
		this.joint = joint;
		this.solde = solde;
	}
	
	public Compte2(String numCompte, boolean joint, long solde, List<Client> clients) {
